...
- Builds Anchor instruction data for staking, reward claims, platform fee routing, governance voting/proposals with explicit voting windows and minimum votes, project registry/participation, SeedBot permissions, and fee config updates
