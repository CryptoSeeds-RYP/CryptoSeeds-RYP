...
- Register project records with ProjectApproval governance binding and min/max participation caps
- Update project lifecycle status with ProjectApproval governance binding
- Record project participation by wallet with project-level allocation accounting
...
- Builds Anchor instruction data for staking, reward claims, platform fee routing, governance voting/proposals with explicit voting windows and minimum votes, project registry/status updates with ProjectApproval account binding, project participation with allocation caps, SeedBot permissions, and fee config updates
