...
- Register project records and update project lifecycle status with ProjectApproval governance binding
...
- Builds Anchor instruction data for staking, reward claims, platform fee routing, governance voting/proposals with explicit voting windows and minimum votes, project registry/status updates with ProjectApproval account binding, project participation, SeedBot permissions, and fee config updates
